...
function Onboarding() {
  ...
  const canContinue = step === 1 ? name.trim().length > 0 : step === 2 ? domains.filter(d => d.selected).length > 0 : true
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-2xl">
        ...
        {step === 1 && (
          <Card>
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold text-foreground text-center mb-6">What's your name?</h2>
              <input
                type="text"
        ...
        {step === 2 && (
          <Card>
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold text-foreground text-center mb-2">Select your focus areas</h2>
