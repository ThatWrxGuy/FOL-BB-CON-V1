...
import { PageContainer, Card, CardHeader, CardTitle, CardContent, Button, Grid } from '../components'
...
const PLANS = [
  ...
  { 
    ...
    price: '$12', 
    period: '/month',
    features: ['Unlimited goals', 'All life domains', 'Advanced analytics', 'Priority support', 'Custom domains', 'API access'],
    popular: true
  },
  { 
    id: 'enterprise', 
    ...
    price: '$49', 
    period: '/month',
    features: ['Everything in Pro', 'Team management', 'SSO integration', 'Custom branding', 'Dedicated support', 'SLA guarantee'],
  },
]
        ...
        {PLANS.map(plan => (
          ...
          >
            ...
            <CardContent className="p-6">
              ...
              >
                {plan.current ? 'Current Plan' : loading === plan.id ? 'Processing...' : 'Subscribe'}
              </Button>
            </CardContent>
          </Card>
        ))}
