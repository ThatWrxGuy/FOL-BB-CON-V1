...
// Mock data
const mockTasks = [
  { id: 1, title: 'Review quarterly goals', priority: 'high', due: 'Today', is_completed: false, category: 'Work' },
  { id: 2, title: 'Schedule health checkup', priority: 'medium', due: 'Tomorrow', is_completed: false, category: 'Health' },
  { id: 3, title: 'Update budget spreadsheet', priority: 'low', due: 'Fri', is_completed: false, category: 'Finance' },
  { id: 4, title: 'Meditation session', priority: 'medium', due: 'Daily', is_completed: true, category: 'Mindset' },
  { id: 5, title: 'Call mom', priority: 'high', due: 'Sun', is_completed: false, category: 'Relationships' },
  { id: 6, title: 'Grocery shopping', priority: 'low', due: 'Today', is_completed: false, category: 'Habits' },
]
  ...
  return (
    <div className="flex items-center gap-3 p-4 hover:bg-secondary/50 transition-colors border-b border-border last:border-0">
      ...
      <div className="flex-1 min-w-0">
        <p className={`font-medium ${task.is_completed ? 'text-foreground-muted line-through' : 'text-foreground'}`}>
          {task.title}
        </p>
    ...
    >
      ...
      {filteredTasks.length > 0 ? (
        ...
        <EmptyState 
          ...
          description={search ? "Try adjusting your search" : "Create your first task to get started"}
          action={
            <Button>
              <FiPlus className="w-4 h-4 mr-2" />
              Create Task
