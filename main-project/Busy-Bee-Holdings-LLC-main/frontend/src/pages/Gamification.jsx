...
const mockAchievements = [
  ...
  // Goals Badges
  { id: 7, name: 'Goal Setter', description: 'Complete your first goal', icon: '🎯', category: 'Goals', earned: true, earnedDate: 'Jan 10, 2024', points: 50 },
  { id: 8, name: 'Goal Getter', description: 'Complete 10 goals', icon: '🏃', category: 'Goals', earned: true, earnedDate: 'Feb 5, 2024', points: 200 },
  { id: 9, name: 'Goal Crusher', description: 'Complete 50 goals', icon: '💪', category: 'Goals', earned: false, points: 500 },
  { id: 10, name: 'Streak Starter', description: '7-day goal completion streak', icon: '⚡', category: 'Goals', earned: true, earnedDate: 'Jan 25, 2024', points: 150 },
  
  // Health Badges
  { id: 11, name: 'First Step', description: 'Log your first workout', icon: '👟', category: 'Health', earned: true, earnedDate: 'Jan 5, 2024', points: 25 },
  { id: 12, name: 'Fitness Fan', description: 'Workout 20 times', icon: '💪', category: 'Health', earned: true, earnedDate: 'Feb 8, 2024', points: 200 },
  { id: 13, name: 'Marathon Runner', description: 'Workout 100 times', icon: '🏅', category: 'Health', earned: false, points: 500 },
  { id: 14, name: 'Health Hero', description: 'Hit all health targets for a week', icon: '🦸', category: 'Health', earned: false, points: 300 },
  
  // Social Badges
  { id: 15, name: 'Social Butterfly', description: 'Connect with 5 friends', icon: '🦋', category: 'Social', earned: true, earnedDate: 'Jan 18, 2024', points: 100 },
  { id: 16, name: 'Community Leader', description: 'Refer 3 friends', icon: '👥', category: 'Social', earned: false, points: 250 },
  
  // Learning Badges
  { id: 17, name: 'Bookworm', description: 'Read 10 books', icon: '📚', category: 'Education', earned: false, points: 300 },
  { id: 18, name: 'Course Completer', description: 'Complete 5 courses', icon: '🎓', category: 'Education', earned: true, earnedDate: 'Feb 3, 2024', points: 200 },
];
