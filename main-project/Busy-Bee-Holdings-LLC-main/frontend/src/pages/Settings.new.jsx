...
import { FiUser, FiBell, FiShield, FiPalette, FiDatabase, FiTrash2 } from 'react-icons/fi'
import { 
    ...
    <PageContainer title="Settings" subtitle="Manage your preferences and account">
      <Tabs defaultValue="account">
        <TabsList className="mb-6">
          <TabsTrigger value="account" icon={FiUser}>Account</TabsTrigger>
          <TabsTrigger value="notifications" icon={FiBell}>Notifications</TabsTrigger>
          <TabsTrigger value="security" icon={FiShield}>Security</TabsTrigger>
          <TabsTrigger value="appearance" icon={FiPalette}>Appearance</TabsTrigger>
          <TabsTrigger value="data" icon={FiDatabase}>Data</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="notifications">
          <Card>
            <CardHeader title="Notification Preferences" description="Choose what notifications you receive" />
            <CardContent className="space-y-4">
              {[
                { id: 'email', label: 'Email Notifications', desc: 'Receive updates via email' },
                { id: 'push', label: 'Push Notifications', desc: 'Receive push notifications on mobile' },
                { id: 'weekly', label: 'Weekly Digest', desc: 'Get a weekly summary of your progress' },
                { id: 'goals', label: 'Goal Reminders', desc: 'Reminders for upcoming goal deadlines' },
              ].map(item => (
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 rounded-lg border border-border">
                ...
                <p className="text-sm text-foreground-muted mb-3">Download all your data in JSON format</p>
