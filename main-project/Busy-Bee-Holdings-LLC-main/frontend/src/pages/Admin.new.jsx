...
import { 
  ...
  Button, Badge, Grid, Tabs, TabsList, TabsTrigger, TabsContent,
  LoadingOverlay
} from '../components'
    ...
    <PageContainer title="Admin" subtitle="System administration">
      <Tabs defaultValue="users">
        <TabsList className="mb-6">
          <TabsTrigger value="users" icon={FiUsers}>Users</TabsTrigger>
          <TabsTrigger value="system" icon={FiActivity}>System</TabsTrigger>
          <TabsTrigger value="security" icon={FiShield}>Security</TabsTrigger>
          <TabsTrigger value="settings" icon={FiSettings}>Settings</TabsTrigger>
        </TabsList>
