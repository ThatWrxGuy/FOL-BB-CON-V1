...
import { PageContainer, Card, CardHeader, CardTitle, CardContent, Button, Input } from '../components'

const FAQS = [
  { q: 'How do I create a new goal?', a: 'Click the "New Goal" button on the Goals page and fill in the details.' },
  { q: 'How does the domain system work?', a: 'Domains help you organize your goals into different life areas like Health, Career, etc.' },
  { q: 'Can I track my progress over time?', a: 'Yes! Check the Analytics page for detailed insights into your performance.' },
  { q: 'How do I connect my accounts?', a: 'Go to Settings > Data > Link Account to connect your financial accounts.' },
]
          ...
          {FAQS.map((faq, i) => (
            <div key={i} className="border-b border-border last:border-0">
              ...
              >
                ...
                <FiExternalLink className={`w-4 h-4 text-foreground-muted transition-transform ${expanded === i ? 'rotate-90' : ''}`} />
              </button>
              {expanded === i && (
                <div className="px-4 pb-4 text-foreground-muted">
                  {faq.a}
                </div>
              )}
            </div>
