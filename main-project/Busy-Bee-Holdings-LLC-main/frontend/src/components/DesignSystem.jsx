...
import { 
  FiHome, FiDollarSign, FiUser, FiSettings, FiLogOut, 
  FiMenu, FiBell, FiSearch, FiGrid, FiTarget, FiCheckSquare, 
  FiTrendingUp, FiBarChart2, FiHelpCircle, FiCreditCard, 
  FiFolder, FiZap, FiChevronLeft, FiChevronRight, FiCommand,
  FiX
} from 'react-icons/fi'
